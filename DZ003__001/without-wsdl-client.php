                ...
                <div class="search-container">
                    <div id="searchTable">
                        <form method="POST" action="" style="padding: 24px;">
                            <label style="padding: 24px; font-weight: bold;">Pretražite narudžbe</label><br><br>
                            <input id="ime" type="text" name="ime" placeholder="🔍 Ime klijenta">
